<template>
    <header class="header">
        ...
        <div class="web-title">后台管理系统</div>
            <div class="colllapse-btn" @click="collapseChange">
        ...
        <div class="header-right">
            ...
            @command="handleCommand">
                ...
                <template #dropdown>
                    <el-dropdown-menu>
                        <a href="http://github.com/linxin/vue-manage-system" 
                        target="_black">
...
<script setup>
import { useSidebarStore } from '../stroe/sidebar'
...
const collapseChange = () => {
    sidebarStore.collapse = !sidebarStore.collapse
}
